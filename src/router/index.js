	...
	},
	{
		...
		children: [
			...
			},
			{
				...
				component: () =>
					import('@/views/payroll_parameter/PayrollParameterList.vue')
			},
			{
			...
			},
			{
				...
				component: () =>
					import('@/views/payroll_parameter/EditPayrollParameter.vue')
			},
			{
				path: 'setup/payroll-parameter/view/:id',
				name: 'view-payroll-parameter',
				component: () =>
					import('@/views/payroll_parameter/ViewPayrollParameter.vue')
			},
			{
			...
			{
				path: 'reports/withholding',
				name: 'reports_withholding',
				component: () =>
					import('@/views/withholding_tax/WithholdingTax.vue')
			}
		]
	}
];
